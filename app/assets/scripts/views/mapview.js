...
var MapView = BaseView.extend({
  ...
  initialize: function () {
    ...
    this.range = [
      Number(_.minBy(oils, function (oil) { return Number(oil['gwp100']['Total Emissions']); })['gwp100']['Total Emissions']),
      Number(_.maxBy(oils, function (oil) { return Number(oil['gwp100']['Total Emissions']); })['gwp100']['Total Emissions'])
    ];
    ...
    oils.forEach(function (oil) {
      ...
      if (oilfield) {
        ...
        var radiusValue = Number(oil['gwp100']['Total Emissions']);
        var ghgTotal = utils.numberWithCommas(oil['gwp100']['Total Emissions']);

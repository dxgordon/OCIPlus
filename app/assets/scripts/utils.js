...
const allKeys = {
  ...
  production: { key: '2017 Crude Production Volume', name: '2017 Crude Production Volume', units: 'barrel oil equivalent' },
  totalProcessed: { key: 'Estimated Total Processed Oil, NGLs, and Gas', name: 'Estimated Total Processed Oil, NGLs, and Gas', units: 'BOE' },
  gasonline: { key: 'Gasoline', name: 'Gasoline Volume', units: 'BOE Product per 1000 BOE' },
  jetFuel: { key: 'Jet Fuel', name: 'Jet Fuel Volume', units: 'BOE Product per 1000 BOE' },
  diesel: { key: 'Diesel', name: 'Diesel Volume', units: 'BOE Product per 1000 BOE' },
  fuelOil: { key: 'Fuel Oil', name: 'Fuel Oil Volume', units: 'BOE Product per 1000 BOE' },
  petcoke: { key: 'Petroleum Coke', name: 'Petroleum Coke Volume', units: 'BOE Product per 1000 BOE' },
